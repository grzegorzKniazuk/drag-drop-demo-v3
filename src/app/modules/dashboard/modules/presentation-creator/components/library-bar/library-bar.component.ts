...
import { HideLibrarySlider } from 'src/app/modules/dashboard/modules/presentation-creator/store/actions';
import { selectIsLibrarySliderOpen } from 'src/app/modules/dashboard/modules/presentation-creator/store/selectors';
