...
import { RemoveSlide, SwapSlideInTheDifferentColumns, SwapSlideInTheSameColumn, UpdateSlidePosition } from 'src/app/modules/dashboard/modules/presentation-editor/store/actions';
...
export class SlideThumbnailComponent extends DropZoneBase implements OnChanges, OnDestroy {
	...
	public onEditSlide(event: MouseEvent): void {
		...
		this.router.navigateByUrl(`/dashboard/presentation-editor/slide/${this.slide.id}`);
	}
