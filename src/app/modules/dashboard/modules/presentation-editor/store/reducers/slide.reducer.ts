...
import { SlideActions, SlideActionsTypes } from 'src/app/modules/dashboard/modules/presentation-editor/store/actions';
...
export function slideReducer(state = initialSlideState, action: SlideActions): SlideState {
	switch (action.type) {
		...
		case SlideActionsTypes.UpdateSlideActions:
